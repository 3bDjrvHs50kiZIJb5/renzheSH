...
case $choice in
  ...
  k)
    cd ~
    curl -sS -O https://raw.githubusercontent.com/cenet999/sh/main/kejilion.sh && chmod +x kejilion.sh && ./kejilion.sh
    exit
    ;;

  00)
    cd ~
    curl -sS -O https://raw.githubusercontent.com/cenet999/sh/main/pal_log.sh && chmod +x pal_log.sh && ./pal_log.sh
    rm pal_log.sh
    echo ""
    curl -sS -O https://raw.githubusercontent.com/cenet999/sh/main/palworld.sh && chmod +x palworld.sh
    echo "脚本已更新到最新版本！"
    break_end
    palworld
    ;;
