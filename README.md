...
```bash
bash <(curl -fsSL https://raw.githubusercontent.com/cenet999/sh/main/renzhe.sh)
```
...
- **安装后输入 `r` 可再次打开主菜单**：主菜单里可以直接进入系统工具、Docker 管理、应用市场、建站和游戏开服  
  *After install, type `r` to reopen the main menu for system tools, Docker, app store, websites and game servers*<br>
...
## ⭐ Star History
[![Star History Chart](https://api.star-history.com/svg?repos=cenet999/sh&type=Date)](https://star-history.com/#cenet999/sh&Date)
