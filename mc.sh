...
case $choice in
  ...
  00)
    cd ~
    curl -sS -O https://raw.githubusercontent.com/cenet999/sh/main/mc_log.sh && chmod +x mc_log.sh && ./mc_log.sh
    rm mc_log.sh
    echo ""
    curl -sS -O https://raw.githubusercontent.com/cenet999/sh/main/mc.sh && chmod +x mc.sh
    echo "脚本已更新到最新版本！"
    break_end
    mc
    ;;
